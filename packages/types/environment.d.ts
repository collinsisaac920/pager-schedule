...
readonly NEXT_PUBLIC_INTERCOM_APP_ID: string | undefined;
    ...
    readonly NEXT_PUBLIC_APP_NAME: string | "Pager Schedule";
    readonly NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS: string | "help@pagerschedule.com";
    readonly NEXT_PUBLIC_COMPANY_NAME: string | "Pager Schedule";
